...
- [Comment.nvim](https://github.com/winston0410/comment.nvim): Facilita a manipulação de comentários no código.
...
- [code_runner.nvim](https://github.com/ltj/coderunner.nvim): Executa código do Neovim.
- [conform.nvim](https://github.com/bronzehedwick/conform.nvim): Formata código automaticamente de acordo com um conjunto de regras definidas.
- [friendly-snippets](https://github.com/jose-elias-alvarez/friendly-snippets): Conjunto amigável de snippets para diversos idiomas.
...
- [nvim-colorizer.lua](https://github.com/norcalli/nvim-colorizer.lua): Colorização de código em tempo real.
...
- [nvim-tree.lua](https://github.com/kyazdani42/nvim-tree.lua): Gerenciador de arquivos para o Neovim.
...
- [solarized-osaka.nvim](https://github.com/windwp/solarized-osaka.nvim): Tema para o Neovim baseado no Solarized.
